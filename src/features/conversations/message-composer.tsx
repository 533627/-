...
export function MessageComposer({ kind, conversationId }: { kind: "department" | "project"; conversationId: string }) {
  ...
  return <form action={action} className="border-t border-base-300 bg-base-100 p-3 sm:p-4" ref={formRef}>
    <input name="kind" type="hidden" value={kind} /><input name="conversationId" type="hidden" value={conversationId} />
