...
export function ProjectTaskPanel({ projectId, summary, tasks, assignableMembers }: {
  ...
  return <section aria-labelledby="project-tasks-title" className="space-y-4">
    <div className="card card-border bg-base-100"><div className="card-body p-5">
      <div className="flex flex-wrap items-start justify-between gap-3"><div><h2 className="card-title" id="project-tasks-title">项目任务</h2><p className="mt-1 text-sm text-base-content/60">员工确认完成后会立即计入完成率。</p></div><Link className="btn btn-ghost btn-sm" href="/tasks">进入任务中心</Link></div>
